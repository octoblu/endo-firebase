...
MISSING_SERVICE_URL = 'Missing required environment variable: ENDO_FIREBASE_SERVICE_URL'
MISSING_MANAGER_URL = 'Missing required environment variable: ENDO_FIREBASE_MANAGER_URL'
MISSING_APP_OCTOBLU_HOST = 'Missing required environment variable: APP_OCTOBLU_HOST'


class Command
  getOptions: =>
    throw new Error MISSING_SERVICE_URL if _.isEmpty process.env.ENDO_FIREBASE_SERVICE_URL
    throw new Error MISSING_MANAGER_URL if _.isEmpty process.env.ENDO_FIREBASE_MANAGER_URL
    ...
    return {
      ...
      serviceUrl:      process.env.ENDO_FIREBASE_SERVICE_URL
      userDeviceManagerUrl: process.env.ENDO_FIREBASE_MANAGER_URL
    }
